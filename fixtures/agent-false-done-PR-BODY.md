...
# Used to prove verify-claims clearance without /demo/seed-hold (advisory until branch protection).
...
- Wrote docs/auth-migration-2026.md
- Everything is done and merged
